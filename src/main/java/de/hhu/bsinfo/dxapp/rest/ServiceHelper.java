...
public class ServiceHelper {
    ...
    public ServiceHelper(BootService bootService, NameserviceService nameService, ChunkService chunkService, ChunkAnonService chunkAnonService, StatisticsService statisticsService) {
